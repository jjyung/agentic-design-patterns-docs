...
- **Pattern Discussion**: [pattern-discussion/routing.md](../pattern-discussion/routing.md)
- **Mermaid Source**: [mermaid-diagrams/routing.mmd](../mermaid-diagrams/routing.mmd)
